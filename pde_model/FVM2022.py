...
x_range = [331, 349]
y_range = [42, 47]
year = 2022 #For naming dataset, should only be changed between files.


# TODO: Change these to 2024
### Related to dataset time and VF
startTime_1 = 192_888       # This repr. 01-01-2020, Hours since 01-01-2000.
startTime_2 = 201_648       # 01-01-2021 
