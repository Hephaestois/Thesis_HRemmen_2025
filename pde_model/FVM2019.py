...
x_range = [331, 349]
y_range = [42, 47]
year = 2019 #For naming dataset, should only be changed between files.


# TODO: Change these to 2024
### Related to dataset time and VF
startTime_1 = 166_584
startTime_2 = 175_344      # This repr. 01-01-2020, Hours since 01-01-2000.
...
### Dataset url
url1 = 'https://tds.hycom.org/thredds/dodsC/GLBy0.08/expt_93.0/uv3z/2019' # No spatial resolution for the dataset is necessary; it is interpolated onto the simulation grid size.
url2 = 'https://tds.hycom.org/thredds/dodsC/GLBy0.08/expt_93.0/uv3z/2020'
